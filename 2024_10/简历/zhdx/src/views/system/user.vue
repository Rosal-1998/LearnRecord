	...
	<div class="g-cont">
		<div class="m-contain">
			...
			<div class="operate-btn">
				<span class="btn down-btn" @click="handledown"><i class="downicon"></i>下载导入模版</span>
				<span class="btn import-btn"><i class="dricon"></i>
			...
			<div class="m-table">
				<el-table :data="datalist" highlight-current-row v-loading="listLoading" style="width: 100%;" border
					...
					<el-table-column prop="userId" label="ID" width="140" :show-overflow-tooltip="true">
					</el-table-column>
					...
					<el-table-column prop="" label="操作">
						<template slot-scope="scope">
							...
							<span class="detail-title" @click="handlecz(scope.row, '1')">&nbsp;&nbsp;重置密码</span>
						</template>
					</el-table-column>
				</el-table>
			</div>
				...
				<div class="dia-cont">
					<el-form :model="addForm" :inline="true" class="formbox" ref="addForm" :rules="addFormRules">
						...
						<el-form-item label="密码" prop="password" v-if="passwordflag">
							<el-input v-model="addForm.password" placeholder="请输入密码" maxlength="20" minlength="5"></el-input>
						</el-form-item>
						<el-form-item label="职务" prop="postName">
						...
						<el-form-item label="工作内容" prop="workContent" style="width: 100%;">
							<el-input type="textarea" v-model="addForm.workContent" placeholder="请输入工作内容" class="max0-ipt"></el-input>
						</el-form-item>
					</el-form>
...
<script>
import { UserList, AddUser, UpdateUser, DelUser, UserUpdateStatus, UserDeptTree, Userdetal, UserInfo, ResetPassword } from '../../api/api.js'
import qs from 'qs'
...
export default {
	...
	methods: {
		...
		handleimport: function (event) {
			...
			axios.post('/system/user/importData?t=' + random, formData, {
				headers: {
