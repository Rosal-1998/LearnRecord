...
class yolov8_heatmap:
    def __init__(self, weight, device, method, layer, backward_type, conf_threshold, ratio, show_box, renormalize,use_cuda=True):
...
def get_params():
    params = {
        'weight': 'runs/train/yolov8_duo5/weights/best.pt', 
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r'/public/home/hpc36037/ljj_UnderwaterObjectDetection/ultralytics-main/dataset/duo/test/images/1006.jpg', 'result')