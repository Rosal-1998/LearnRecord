...
from ultralytics.nn.modules import Rfm
...
class BaseModel(nn.Module):
    ...
    def _predict_augment(self, x):
        ...
        LOGGER.warning(
            f"WARNING 鈿狅笍 {self.__class__.__name__} does not support augmented inference yet. "
...
def parse_model(d, ch, verbose=True, warehouse_manager=None):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, Focus,Rfm,
            ...
            print('m',m)
            print('---c2?----',m.feature_info.channels())
