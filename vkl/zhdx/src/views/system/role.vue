				...
				<el-table :data="datalist" highlight-current-row v-loading="listLoading" style="width: 100%;" border
					...
					<el-table-column prop="" label="操作">
						<template slot-scope="scope">
							...
							<el-popover :ref="scope.row.roleId" placement="top" width="160" popper-class="popover">
								<p class="del-tip">是否删除该角色信息？</p>
								<div class="pop-btnbox">
									<span class="cancel-btn" @click="visibleDelCancel(scope.row.roleId)">取消</span>
				...
				<div class="dia-cont">
					<el-form :model="addForm" :inline="true" class="formbox" ref="addForm" :rules="addFormRules">
						...
						<el-form-item label="权限字符" prop="roleKey">
							<el-input v-model="addForm.roleKey" placeholder="请输入权限字符"></el-input>
						</el-form-item>
						<el-form-item label="角色顺序" prop="roleSort">
							<el-input v-model="addForm.roleSort" placeholder="请输入角色顺序"></el-input>
						</el-form-item>
						...
						<el-form-item label="权限" prop="rolePermissionsIds" style="width: 100%;">
							<el-tree class="role-treebox" :data="treeData" show-checkbox ref="roletree" node-key="id"
								:default-checked-keys="addForm.menuIds" @node-click="handleClick" empty-text="加载中，请稍候"
								:props="defaultProps"></el-tree>
						</el-form-item>
						<el-form-item label="备注" prop="remark" style="width: 100%;">
							<el-input type="textarea" v-model="addForm.remark" placeholder="请输入备注符" class="max0-ipt"></el-input>
						</el-form-item>
					</el-form>
...
<script>
import { RoleList, AddRole, UpdateRole, DelRole, RolefindById, Treeselect, RoleUpdateStatus, RoleMenuTreeselect } from '../../api/api.js'
import qs from 'qs'
	...
	data() {
		...
		return {
			...
			addFormRules: {
				...
				rolePermissionsIds: [{ required: true, validator: validatePass, trigger: "change" }],
