<template>
	<section class="g-cont">
		...
		<!--新增界面-->
		<el-dialog :visible.sync="addFormVisible" @close="dailogclose" :append-to-body="true" class="g-dialog" :title="diatitle">
			<div class="dia-contont">
				<div class="dia-cont">
					<el-form :model="addForm" :inline="true" :rules="addFormRules" ref="addForm" class="addform">
