          ...
          <template>
            ...
            >
              ...
              <div class="pop-btnbox">
                <span class="cancel-btn" @click="visibleDelete = !visibleDelete"
                  >取消</span
                >
...
import {
  ...
  EvtFlowBackReport,
  EvtReportAgain,
  EvtFlowDelete,EventDeleteInOnce,
...
export default {
  ...
  methods: {
    ...
    slfpsubmit: function () {
      ...
      this.$refs['yjForm'].validate((vaild) => {
        if (vaild) {
          let c = []
